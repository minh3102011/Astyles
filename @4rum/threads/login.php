...
<meta property="og:url" content="../threads" />
...
<!--
	...
	var RELPATH = "../threads/login.php?do=login";
	var PATHS = {
		forum : "",
		cms   : "",
		blog  : ""
...
<div class="standard_error">
	<h2 class="blockhead">Tin nhắn hệ thống</h2>
		...
		<div class="blockbody formcontrols">
			<div class="blockrow restore">Không có Chủ đề. Nếu bạn theo đúng địa chỉ, xin hãy báo cho <a href="../sendmessage.php">BQT</a></div>
		</div>
...
<div id="footer_morecopyright" class="shade footer_morecopyright">
	...
	<img src="../cron.php?rand=1373048429" alt="" width="1" height="1" border="0" />
	<!-- Do not remove cronimage or your scheduled tasks will cease to function -->
