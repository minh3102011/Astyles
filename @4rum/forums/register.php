...
<!--
	...
	var RELPATH = "../forums/register.php";
	var PATHS = {
		forum : "",
		cms   : "",
		blog  : ""
...
<div class="standard_error">
	<h2 class="blockhead">Tin nhắn hệ thống</h2>
		...
		<div class="blockbody formcontrols">
			<div class="blockrow restore">Không có Diễn đàn. Nếu bạn theo đúng địa chỉ, xin hãy thông báo cho <a href="../sendmessage.php">BQT</a></div>
		</div>
...
<div id="footer_morecopyright" class="shade footer_morecopyright">
	...
	<img src="../cron.php?rand=1375055675" alt="" width="1" height="1" border="0" />
	<!-- Do not remove cronimage or your scheduled tasks will cease to function -->
