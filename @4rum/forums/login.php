...
$(document).ready(function() {
    ...
    $("._show").change(function(){
        ...
        $("#_login_button").show();
        document.reg_log.action = "login.php?s=d5b30cdd2e9ef3e156781183d3f0d5be&amp;do=login";
        $("#1").attr("name", "s");
        $("#2").attr("name", "do");
...
<!--
	...
	var SESSIONURL = "s=d5b30cdd2e9ef3e156781183d3f0d5be&";
	...
	var RELPATH = "../forums/login.php?do=login";
	var PATHS = {
		forum : "",
		cms   : "",
		blog  : ""
...
<script type="text/javascript" src="../clientscript/vbulletin-core.js?v=420"></script>
	...
	<link rel="stylesheet" type="text/css" href="../clientscript/vbulletin_css/style00020l/main-rollup.css?d=1374981656" />
        

	<!--[if lt IE 8]>
	<link rel="stylesheet" type="text/css" href="../clientscript/vbulletin_css/style00020l/popupmenu-ie.css?d=1374981656" />
	<link rel="stylesheet" type="text/css" href="../clientscript/vbulletin_css/style00020l/vbulletin-ie.css?d=1374981656" />
	<link rel="stylesheet" type="text/css" href="../clientscript/vbulletin_css/style00020l/vbulletin-chrome-ie.css?d=1374981656" />
	<link rel="stylesheet" type="text/css" href="../clientscript/vbulletin_css/style00020l/vbulletin-formcontrols-ie.css?d=1374981656" />
	<link rel="stylesheet" type="text/css" href="../clientscript/vbulletin_css/style00020l/editor-ie.css?d=1374981656" />
	<![endif]-->
...
<link rel="stylesheet" type="text/css" href="../clientscript/vbulletin_css/style00020l/additional.css?d=1374981656" />
...
<div id="_panel">
<form action="login.php?s=d5b30cdd2e9ef3e156781183d3f0d5be&amp;do=login" method="post" name="reg_log" onsubmit="md5hash(vb_login_password, vb_login_md5password, vb_login_md5password_utf, 0)">
...
<input id="1" type="hidden" name="s" value="d5b30cdd2e9ef3e156781183d3f0d5be" /><input type="hidden" name="do" id="2" value="login" /><input type="hidden" id="3" name="vb_login_md5password" /><input type="hidden" id="4" name="vb_login_md5password_utf" />
...
<!-- End User panel -->
	...
	<div><a name="top" href="index.php?s=d5b30cdd2e9ef3e156781183d3f0d5be" class="logo-image"><img src="../images/xenfovb/logo.png" alt="     Astyles.Org | New Style For You" /></a></div>
<div class="clock"></div>
...
<a href="../faq.php?s=d5b30cdd2e9ef3e156781183d3f0d5be" class="OverlayTrigger jumpMenuTrigger" data-cacheoverlay="true" title="Open quick navigation"><!FAQ--></a>
<span class="crumbs">
...
<div class="standard_error">
	<h2 class="blockhead">Tin nhắn hệ thống</h2>
		...
		<div class="blockbody formcontrols">
			<div class="blockrow restore">Không có Diễn đàn. Nếu bạn theo đúng địa chỉ, xin hãy thông báo cho <a href="../sendmessage.php?s=d5b30cdd2e9ef3e156781183d3f0d5be">BQT</a></div>
		</div>
