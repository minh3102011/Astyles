...
b.id||this.id()==b||this.getParent()==b)return a=this,!1});return a}if(arguments.length>1){var e=arguments[1],d=arguments.length==3?arguments[2]:{};typeof e=="string"&&(e={src:e});e=n({bgcolor:"#000000",version:[9,0],expressInstall:"https://static.flowplayer.org/swf/expressinstall.swf",cachebusting:!1},e);if(typeof b=="string")if(b.indexOf(".")!=-1){var h=[];i(r(b),function(){h.push(new k(this,j(e),j(d)))});return new m(h)}else{var g=document.getElementById(b);return new k(g!==null?g:b,e,d)}else if(b)return new k(b,
